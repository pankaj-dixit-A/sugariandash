    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
          ...
          //  string monumber = Session["Company_Phone"].ToString();
            GSTNO = Convert.ToString(clsCommon.getString("select GST from Company where  Company_Code='" + company_code + "'"));
            ...
            string imagepath = clsCommon.getString("select ImagePath from tblsign where ImageOrLogo='O' and Company_Code='"
                 + Session["Company_Code"].ToString() + "'");
            String path = Server.MapPath("") + "\\" + imagepath; 

            imagepath = path.Replace("Report", "Images");

            string logo = clsCommon.getString("select ImagePath from tblsign where ImageOrLogo='M' and Company_Code='"
             + Session["Company_Code"].ToString() + "'");
