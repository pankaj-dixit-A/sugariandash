            ...
            if (ViewState["mode"] != null)
            {
                ...
                if (ViewState["mode"].ToString() == "I")
                {
                    ...
                    obj.columnNm = "DOC_NO,Tran_Type,PURCNO,DOC_DATE,AC_CODE,Unit_Code,MILL_CODE,FROM_STATION,TO_STATION,LORRYNO,BROKER,WEARHOUSE,SUBTOTAL," +
                        ...
                        "SGSTAmount,IGSTRate,IGSTAmount,TaxableAmount,GstRateCode,Company_Code,Year_Code,Branch_Code,Created_By,Transport_Code,DO_No,RateDiff,ASN_No,RoundOff, Eway_Bill_No,TCS_Rate,TCS_Amt,TCS_Net_Payable,newsbno,newsbdate,einvoiceno,ackno,TDS_Rate,TDS_Amt";
                    obj.values = "'" + DOC_NO + "','" + trntype + "','" + PURCNO + "','" + DOC_DATE + "','" + AC_CODE + "','" + Unit_Code + "','"
                        ...
                        + SGSTRate + "','" + SGSTAmount + "','" + IGSTRate + "','" + IGSTAmount + "','" + TaxableAmount + "','" + GstRateCode + "','" + Convert.ToInt32(Session["Company_Code"].ToString())
                ...
                else
                {
                    ...
                    obj.columnNm = "DOC_NO='" + DOC_NO + "',Tran_Type='" + trntype + "',PURCNO='" + PURCNO + "',DOC_DATE='" + DOC_DATE
                        ...
                        + IGSTAmount + "',TaxableAmount='" + TaxableAmount + "',GstRateCode='" + GstRateCode + "',RoundOff='" + roundoff + "',Eway_Bill_No='" + EWAYBILL + "',TCS_Rate='" + TCS_Rate + "',TCS_Amt='" + TCS_Amt + "',TCS_Net_Payable='" + TCS_Net_Payable + "',newsbno='" + newsbno + "',newsbdate='" + newsbdate + "',einvoiceno='" + einvoiceno + "',ackno='" + ackno + "' ,TDS_Rate='" + TDS_Rate + "',TDS_Amt='" + TDS_Amt + "' where doc_no=" + DOC_NO + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()) + " and Year_Code=" + Convert.ToInt32(Session["year"].ToString());
                    obj.values = "none";
                    ds = new DataSet();
                    ds = obj.insertAccountMaster(ref strRev);
                    retValue = strRev;
